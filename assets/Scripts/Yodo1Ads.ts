...
export default class Yodo1Ads extends Component {
  ...
  public setCOPPA(isEnabled: boolean) {
  ...
  public setGDPR(isEnabled: boolean) {
    native.reflection.callStaticMethod(
      "com/cocos/game/AppActivity",
      "setGDPR",
      "(Z)V",
  ...
  public setCCPA(isEnabled: boolean) {
    native.reflection.callStaticMethod(
      "com/cocos/game/AppActivity",
      "setCCPA",
      "(Z)V",
  ...
  public initializeMasSdk(appkey: string, isEnabled: boolean) {
    console.log("Native Call to Initialize MAS SDK");
    native.reflection.callStaticMethod(
      "com/cocos/game/AppActivity",
      "initializeSdk",
  ...
  public initializeInterstitialAds() {
    console.log("Native Call to Initialize Interstitial Ads");
    native.reflection.callStaticMethod(
      "com/cocos/game/AppActivity",
